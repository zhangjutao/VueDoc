...
所有的浏览器渲染引擎工作流程大致分为5步：创建 <font color=red>DOM 树 </font>—> 创建<font color=red> Style Rules </font>-> 构建<font color=red> Render 树 </font>—> 布局<font color=red> Layout </font>-—> 绘制<font color=red> Painting </font>。
